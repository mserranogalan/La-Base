...
namespace Coolant {
    ...
    public class DevExtremeBundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            scriptBundle
                .Include("~/Scripts/dx.all.js")             //Estaba Comentado
                .Include("~/Content/lib/jszip/jszip.min.js")
            ...
            styleBundle
                ...
                .Include("~/Content/dx.material.blue.light.css")
                .Include("~/Content/st.custom.theme.css")
                .Include("~/fonts/fontawesome/css/all.min.css")
                .Include("~/fonts/material-icons/material-icons.css");
